...
class BattleshipStart {
	...
	public static void promptCoords() {
		...
		String[] splittedCoords = input.split(" ");
		int x1Coord = (int) splittedCoords[0].charAt(0) - 65;
		int x2Coord = (int) splittedCoords[2].charAt(0) - 65;
		int y1Coord = Integer.parseInt(splittedCoords[1].substring(1)) - 1;
		int y2Coord = Integer.parseInt(splittedCoords[3].substring(1)) - 1;
	}
