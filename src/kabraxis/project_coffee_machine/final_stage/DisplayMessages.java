...
public class DisplayMessages {
    ...
    public final String ERROR_EXIT = "Turning off...";
    ...
    public final String MISSING_ITEM = String.format("Sorry, not enough %s!%n%n",);
    public final String TAKE_MESSAGE = String.format("%nI gave you $%d%n",deLuvos);
