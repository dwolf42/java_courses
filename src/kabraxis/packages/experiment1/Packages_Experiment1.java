package kabraxis.packages.experiment1;

import kabraxis.oop.my_work.clock.Display;

public class Packages_Experiment1 {
    public static void main(String[] args) {
        java.util.Scanner scanner = new java.util.Scanner(System.in);
        kabraxis.oop.my_work.clock.Clock clock1 = new kabraxis.oop.my_work.clock.Clock();
