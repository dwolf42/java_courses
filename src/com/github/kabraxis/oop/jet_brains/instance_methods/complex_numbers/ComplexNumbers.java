package com.github.kabraxis.oop.jet_brains.instance_methods.complex_numbers;
 ...
 *
 * add(Complex num) that takes another complex number as an argument and adds its corresponding fields to
 ...
 *
 * Let's consider the example for the add method. If number = 10 + 4i and anotherNumber = 6 + 6i,
 * applying the method add to number with the argument anotherNumber changes number to number = 16 + 10i
 *
 * Complex number = new Complex();
 * number.real = 10;
 * number.image = 4;
